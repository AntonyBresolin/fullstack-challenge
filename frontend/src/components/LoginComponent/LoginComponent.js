  ...
  return (
    <div className='h-full w-full flex flex-col items-center justify-between py-[20%]'>
      ...
      <form className='flex flex-col items-center justify-center w-full px-[20%] gap-y-4' onSubmit={handleSubmit}>
        <input type="text" placeholder="Insira seu CPF" className="w-full pl-4 mx-4 py-4 mb-4 border rounded-md border-emerald-200 shadow-md focus:outline-none focus:border-emerald-700 focus:ring-1 focus:ring-emerald-700
